...
| `frontend-React/README.md` | Frontend package README | Generic Vite stub | Initial scaffold | Low |
| `frontend-React/src/content/projects/MARKDOWN_AUTHORING_GUIDE.md` | Authoring guide for frontend markdown renderer | Useful and current | Docs modal hardening | Medium |
...
| `frontend-React/src/content/projects/cloud-resume-rag/en/*.md` | Frontend-facing capstone docs | Current-facing, good depth | Capstone docs modal | High |
| `frontend-React/src/content/projects/cloud-resume-rag/zh-TW/*.md` | Traditional Chinese capstone docs | Current-facing translation | Capstone docs modal | Medium |
| `frontend-React/src/content/projects/recipe-sharing-app/en/*.md` | Historical recipe app docs | One file far too large | Historical AWS learning project | Medium |
| `frontend-React/src/content/projects/recipe-sharing-app/zh-TW/*.md` | Traditional Chinese recipe app docs | Short placeholder-like docs | Historical project | Low |
| `frontend-React/src/content/projects/event-announcement-system/*/*.md` | Frontend-facing event system docs | Mostly placeholders/planned | Future AWS project | Low |
| `frontend-React/src/content/projects/jenkins-cicd/*/*.md` | Frontend-facing Jenkins docs | Mostly placeholders/historical | Historical learning project | Low |
| `frontend-React/src/content/projects/ec2-apache-website/*/*.md` | Frontend-facing EC2 Apache docs | Mostly placeholders/historical | Historical learning project | Low |
...
### `frontend-React/src/content/projects/MARKDOWN_AUTHORING_GUIDE.md`
...
### `frontend-React/src/content/projects/cloud-resume-rag/en/overview.md`
...
### `frontend-React/src/content/projects/cloud-resume-rag/en/architecture.md`
...
### `frontend-React/src/content/projects/cloud-resume-rag/en/implementation.md`
...
### `frontend-React/src/content/projects/cloud-resume-rag/zh-TW/overview.md`
...
### `frontend-React/src/content/projects/cloud-resume-rag/zh-TW/architecture.md`
...
### `frontend-React/src/content/projects/cloud-resume-rag/zh-TW/implementation.md`
...
### `frontend-React/src/content/projects/recipe-sharing-app/en/overview.md`
...
### `frontend-React/src/content/projects/recipe-sharing-app/en/architecture.md`
...
### `frontend-React/src/content/projects/recipe-sharing-app/en/implementation.md`
...
### `frontend-React/src/content/projects/recipe-sharing-app/zh-TW/*.md`
...
### `frontend-React/src/content/projects/event-announcement-system/en/*.md`
...
### `frontend-React/src/content/projects/event-announcement-system/zh-TW/*.md`
...
### `frontend-React/src/content/projects/jenkins-cicd/en/*.md`
...
### `frontend-React/src/content/projects/jenkins-cicd/zh-TW/*.md`
...
### `frontend-React/src/content/projects/ec2-apache-website/en/*.md`
...
### `frontend-React/src/content/projects/ec2-apache-website/zh-TW/*.md`
...
| `frontend-React/README.md` | Low | Low | Low | Low | Low | Low | 2/10 |
...
2. `frontend-React/README.md`: replace Vite scaffold with real frontend setup, env vars, scripts, screenshots, and deployment.
...
- `frontend-React/README.md` is still a generic Vite README.
...
- `frontend-React/README.md` is effectively dead scaffold text.
...
- `FRONTEND_ENGINEERING_REPORT.md`
- `BACKEND_ENGINEERING_REPORT.md`
- `frontend-React/src/content/projects/cloud-resume-rag/en/*.md`
...
1. Create a root `README.md` and replace `frontend-React/README.md`.
