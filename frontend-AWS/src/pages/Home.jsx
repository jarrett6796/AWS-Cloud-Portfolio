...
const PROJECT_WORKSPACES = {
  ...
  project2: {
    ...
    fullName: "Event-Driven Notification System",
    projectIds: ["event-system"],
  },
  project3: {
    shortLabel: "Project 3",
    fullName: "URL Shortener",
    projectIds: ["url-shortener"],
  },
  project4: {
    shortLabel: "Project 4",
    fullName: "QR Code Generator",
    projectIds: ["qr-code-generator"],
  },
  project5: {
    shortLabel: "Project 5",
    fullName: "Real-Time Chat Application",
    projectIds: ["real-time-chat"],
  },
  project6: {
    shortLabel: "Project 6",
