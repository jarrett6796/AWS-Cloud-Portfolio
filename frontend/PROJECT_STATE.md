...
- White, clean, and structured in light mode
...
Light mode is already the most polished baseline. Keep it mostly unchanged unless a change is necessary for consistency.
